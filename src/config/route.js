...
export const getRouterData = app => {
  const routerConfig = {
    '/': {
      component: dynamicWrapper(app, ['login','global'], () => import('../layouts/BasicLayout')),
    },
    '/home': {
    ...
    '/user/login': {
      component: dynamicWrapper(app, [], () => import('../components/Login')),
    },
    '/configuration/business_configuration': {
      component: dynamicWrapper(app, [], () => import('../pages/Home')),
    },
    '/exception/403': {
